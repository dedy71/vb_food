...
Public Class Koneksi
    ...
    Public Function OpenConn() As Boolean
        Cn = New OleDb.OleDbConnection(
            "Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;User ID=wildan;Password=12345;Initial Catalog=DbPenjualanObat;Data Source=DESKTOP-LDECR5B")
        Cn.Open()
