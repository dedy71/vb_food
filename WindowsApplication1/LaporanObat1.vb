...
Public Class LaporanObat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiPenjualanObat.LaporanObat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanObat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanObat = New LaporanObat()
        rpt.Site = Me.Site
        Return rpt
    End Function
